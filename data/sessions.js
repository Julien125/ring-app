...
export const SESSIONS = [
  {
    ...
    supersets: [
      {
        id: 'A', label: 'Skill (fresh, first)', rings: 'none', rounds: 4,
        restIntra: 60, restRound: 90,
        exercises: [
          { ...EX['chest-wall-handstand'], note: '4 x 15s, 60s-method @ ~50% max hold — L1 Wall HS — the current cell. Fresh, first, quality over fatigue' },
          { ...EX['wall-kick-up'], note: '4 x 12, same lead leg every rep — entry mechanics toward Free HS (L4)', targetReps: 12 },
          { ...EX['planche-lean'], note: '4 x 15s, maximum protraction — upper back rounded, shoulders past the wrists — SERRATUS standing priority, upgraded from the banded scapular push-up to a max-leverage isometric. NOTE: planche-lean feeds PLANCHE only, not handstand — it is justified here by the standing serratus rule, not by skill-feeding. The handstand-feeding protraction work is preserved as Planche Protraction on Friday (feeds planche + handstand). tissue_load HIGH + straight arm — takes the 3rd and final weekly slot.' },
        ],
      },
      {
        ...
        exercises: [
          { ...EX['hspu'], note: '4-4-4-X (last to failure) — current max 5 -> m-1 = 4; feeds handstand + shoulderstand-press; advance if last >= first+2', targetReps: 4 },
  ...
  },
  {
    ...
    supersets: [
      {
        id: 'A', label: 'Skill (fresh, first)', rings: 'mid', rounds: 4,
        restIntra: 60, restRound: 90,
        exercises: [
          { ...EX['muscle-up-negative'], note: '4 x 3, 5-8s descent — L2 MU Negatives — the current cell. Control the elbow-past-chest moment', targetReps: 3 },
      ...
      {
        id: 'B', label: 'Strength — feeds the pushed skills (LSTF)', rings: 'bar', rounds: 4,
        restIntra: 45, restRound: 120,
        exercises: [
          { ...EX['chest-to-bar'], note: '6-6-6-X (last to failure) — current max 7 -> 6; the explosive pull that feeds the muscle-up', targetReps: 6 },
      ...
      {
        id: 'D', label: 'Core / compression', rings: 'none', rounds: 4,
        restIntra: 45, restRound: 120,
        exercises: [
          { ...EX['v-sit-pulse'], note: '60s-method at end range — L6 45-deg V-Sit — the manna cell. counts_as_core', targetReps: 'hold' },
          { ...EX['butt-lift'], note: '4 x 8, 1-2s hold at top — manna support — L-sit compression lift. counts_as_core, so NO separate Core Finisher today', targetReps: 8 },
        ],
      },
    ],
    ...
    supersets: [
      {
        ...
        exercises: [
          ...
          { ...EX['toe-pulls'], note: '4 x 12 — balance-correction reflex — the actual gate on a free handstand', targetReps: 12 },
          ...
          { ...EX['planche-protraction'], note: '4 x 10-12, 2s hold at max protraction — SERRATUS standing priority; horizontal-push quadrant volume', targetReps: '10-12' },
        ],
      },
      {
        id: 'B', label: 'Strength — feeds the pushed skills (LSTF)', rings: 'none', rounds: 4,
      ...
      {
        id: 'C', label: 'Hypertrophy — patch what the skills miss', rings: 'mid', rounds: 3,
        restIntra: 45, restRound: 120,
        exercises: [
      ...
      {
        id: 'D', label: 'Core Finisher — V-ab', rings: 'none', rounds: 4,
        restIntra: 45, restRound: 120,
        exercises: [

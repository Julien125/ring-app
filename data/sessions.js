...
export const SESSIONS = [
  {
    ...
    supersets: [
      {
        id: 'A', label: 'Skill (fresh, first)', rings: 'none', rounds: 6,
        ...
        exercises: [
          ...
          { ...EX['wall-kick-up'], note: '6 x 12, same lead leg every rep — entry mechanics toward Free HS (L4)', targetReps: 12 },
          { ...EX['planche-lean'], note: '6 x 15s, maximum protraction — upper back rounded, shoulders past the wrists — SERRATUS standing priority, upgraded from the banded scapular push-up to a max-leverage isometric. NOTE: planche-lean feeds PLANCHE only, not handstand — it is justified here by the standing serratus rule, not by skill-feeding. The handstand-feeding protraction work is preserved as Planche Protraction on Friday (feeds planche + handstand). tissue_load HIGH + straight arm — takes the 3rd and final weekly slot.' },
        ],
      },
      {
        id: 'B', label: 'Strength — feeds the pushed skills (LSTF)', rings: 'none', rounds: 5,
  ...
  },
  {
    ...
    supersets: [
      {
        id: 'A', label: 'Skill (fresh, first)', rings: 'mid', rounds: 5,
        restIntra: 60, restRound: 90,
        exercises: [
      ...
      {
        id: 'B', label: 'Strength — feeds the pushed skills (LSTF)', rings: 'bar', rounds: 5,
        restIntra: 45, restRound: 120,
        exercises: [
          { ...EX['chest-to-bar'], note: '6-6-6-6-X (last to failure) — current max 7 -> 6; the explosive pull that feeds the muscle-up', targetReps: 6 },
          { ...EX['row'], note: '8-8-8-8-X (last to failure) — current max 9 -> 8; feeds muscle-up + front-lever; horizontal-pull volume', targetReps: 8 },
        ],
      },
      {
      ...
      },
      {
        ...
        restIntra: 45, restRound: 120,
        exercises: [
          { ...EX['v-sit-pulse'], note: '5 x 10 small pulses at end range — L6 45-deg V-Sit — the manna cell. counts_as_core', targetReps: 10 },
